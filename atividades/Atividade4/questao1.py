...
# O operador de resto (%) divide o número por 2 e devolve apenas o que restou. Se a divisão for exata (resto 0),
# o número é par.f"O número {numero}...": Essa é uma f-string. Ela permite que você coloque a variável número direto
